...
export type WidgetAction =
    ...
    | { type: 'UPDATE_WIDGET'; payload: Partial<Widget> & { id: string | number } }
    | { type: 'REORDER_WIDGET'; payload: { id: string | number; x: number; y: number } }
    | { type: 'RESIZE_WIDGET'; payload: { id: string | number; width: number; height: number } }
